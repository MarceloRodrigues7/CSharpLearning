...
▀▀▀░ ▄▄▄█ ░░▀░░ ▀▀▀ ▀▀▀░ ▀░░▀ ▀░░▀ ▀░▀");
        ...
        public void Sacar(decimal quantia)
        {
            ...
            switch (resultado)
            {
                case ResultadoOperacao.OperacaoIniciada: Console.WriteLine("Resultado: Operacão iniciada"); break;
                case ResultadoOperacao.SaldoInsuficiente: Console.WriteLine("Resultado: Saldo insuficiente"); break;
                case ResultadoOperacao.Sucesso: Console.WriteLine("Resultado: Sucesso"); break;
                case ResultadoOperacao.ErroNaoTemDinheiro: Console.WriteLine("Resultado: Erro não tem dinheiro"); break;
                case ResultadoOperacao.ErroComunicacaoComServidor: Console.WriteLine("Resultado: Erro de comunicação com Servidor"); break;
                default: Console.WriteLine("Resultado: Erro desconhecido"); break;
            }
        }
    }
